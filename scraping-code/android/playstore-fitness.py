...
FITNESS_URL = 'https://play.google.com/store/apps/category/HEALTH_AND_FITNESS'
COUNTRY_CODES = ['HR', 'CY', 'CZ', 'DK', 'EE', 'FO', 'FI', 'FR', 'GF', 'PF', 'DE', 'GI', 'GR', 'GL', 'GP', 'HU', 'IS', 'IE', 'IT', 'LV', 'LI', 
                'LT', 'LU', 'MT', 'MQ', 'YT', 'MC', 'NL', 'NC', 'NO', 'PL', 'PT', 'RE', 'RO', 'SM', 'SK', 'SI', 'ES', 'BL', 'MF', 'PM', 'SJ', 'SE',
                 'GB', 'VA', 'WF', 'AX', 'AT', 'BE', 'BG']
...
for country_code in COUNTRY_CODES:
    ...
    while(is_done == False):
        try:
            with (open(f'google-fitness-{country_code}.csv', 'w+')) as new_file:
                ...
                links = get_all_links_from_page(f'{FITNESS_URL}?gl={country_code}', CATEGORIES)
                for link in links:
